...
-- function(mo, player) //Fire rings
-- 		S_StartSound(player.mo,sfx_brakrl)
-- 		player.pr_missilelauncher = missilelauncher_time
...
table.insert(CBW_PowerCardQueue, {
	...
	chance		= 5,
	health		= ammo,
	flags		= PCF_NOSPIN|PCF_RUNNERDEBUFF,
